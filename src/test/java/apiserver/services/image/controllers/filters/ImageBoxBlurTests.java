 ...
 */
@IntegrationTest
public class ImageBoxBlurTests extends FilterTestBase
{
    ...
    public void testBoxBlurByIdRESTGet() throws Exception
    {
        ...
        saveFileToLocalDisk("boxblur-get.jpg", result.getResponse().getContentAsByteArray());
    }
    ...
    public void testBoxBlurByIdRESTPost() throws Exception
    {
        ...
        MvcResult result = MockMvcBuilders.webAppContextSetup((WebApplicationContext) context).build()
                .perform(fileUpload(rootUrl + "/image/filter/boxblur.jpg")
                        .file(file)
                        .param("hRadius", "2")
                        .param("vRadius", "2")
                        .param("iterations", "1")
