 ...
 * Date: 7/7/13
 */
public class ImageMinimumTests extends FilterTestBase
{
    ...
    public void testLensBlurByIdRESTGet() throws Exception {
        ...
        Assert.assertEquals(1292170, result.getResponse().getContentLength());
        saveFileToLocalDisk("minimum-get.jpg", result.getResponse().getContentAsByteArray());
    }
    ...
    public void testLensBlurByIdRESTPost() throws Exception {
        ...
        Assert.assertEquals(1292170, result.getResponse().getContentLength());
        saveFileToLocalDisk("minimum-post.jpg", result.getResponse().getContentAsByteArray());
    }
}
