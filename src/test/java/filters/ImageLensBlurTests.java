...
@ImportResource("flows/filters/filterLensBlur-flow.xml")
public class ImageLensBlurTests
{
    ...
    {
        File file = new File(  ImageLensBlurTests.class.getClassLoader().getResource("IMG_5932.JPG").toURI()  );
    ...
    public void testLensBlurByFile() throws TimeoutException, ExecutionException, InterruptedException, IOException
    {
        ...
        Assert.assertEquals("Invalid image bytes",  21627285, result.getBody().length);
    }
    ...
    public void testLensBlurBase64ByFile() throws TimeoutException, ExecutionException, InterruptedException, IOException
    {
        ...
        Assert.assertEquals("Invalid image bytes",  28836380, result.getBody().length);
    }
}
