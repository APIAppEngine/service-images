...
@ImportResource("flows/filters/filterGrayScale-flow.xml")
public class ImageGrayScaleTests
{
    ...
    {
        File file = new File(  ImageGrayScaleTests.class.getClassLoader().getResource("IMG_5932.JPG").toURI()  );
    ...
    public void testGrayScaleByFile() throws TimeoutException, ExecutionException, InterruptedException, IOException
    {
        ...
        Assert.assertEquals("Invalid image bytes",  11039814, result.getBody().length);
    }
    ...
    public void testGrayScaleBase64ByFile() throws TimeoutException, ExecutionException, InterruptedException, IOException
    {
        ...
        Assert.assertEquals("Invalid image bytes",  14719752, result.getBody().length);
    }
}
