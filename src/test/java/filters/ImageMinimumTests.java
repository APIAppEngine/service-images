...
@ImportResource("flows/filters/filterMinimum-flow.xml")
public class ImageMinimumTests
{
    ...
    {
        File file = new File(  ImageMinimumTests.class.getClassLoader().getResource("IMG_5932.JPG").toURI()  );
    ...
    public void testMinimumByFile() throws TimeoutException, ExecutionException, InterruptedException, IOException
    {
        ...
        Assert.assertEquals("Invalid image bytes",  19749506, result.getBody().length);
    }
    ...
    public void testMinimumBase64ByFile() throws TimeoutException, ExecutionException, InterruptedException, IOException
    {
        ...
        Assert.assertEquals("Invalid image bytes",  26332676, result.getBody().length);
    }
}
